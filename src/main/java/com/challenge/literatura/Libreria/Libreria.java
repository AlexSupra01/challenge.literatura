...
import com.challenge.literatura.models.LibrosRespuestaApi;
...
public class Libreria {
    ...
    public Libreria(repositorioLibro libroRepository, repositorioAutor autorRepository) {
        ...
        while (opcion != 0){
            ...
            switch (opcion){
                ...
                default:
                    ...
                    System.out.println("Intente con una nueva opción por favor");
                    consumo();
                    break;
            }
        }
    ...
    private void buscarLibroPorNombre() {
        System.out.println("Ingrese el titulo libro que quiere buscar: ");
    ...
    private  void BuscarAutores(){
        ...
        if (autores.isEmpty()) {
            ...
            System.out.println("Libros encontrados en la base de datos son: \n");
